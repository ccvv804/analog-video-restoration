...
def main(args):
    ...
    dataloader = DataLoader(test_dataset, batch_size=1, shuffle=False, num_workers=12, pin_memory=True)
    ...
    for batch in dataloader:
        ...
        for i in range(output.shape[0]):
            ...
            #print(f"./results/video_swin_unet/{img_name[i]}")
            cv2.imwrite(f"./results/video_swin_unet/{img_name[i]}", restored)
